...
The author of this package is Vivian Wang, who wrote the functions and Shiny
app implementation.
...
`runCovidWasteWatch` and `app.R` used `Shiny` to provide an interactive app for
this package.
...
use the [GitHub issues](https://github.com/viv-wang/CovidWasteWatch/issues). 
