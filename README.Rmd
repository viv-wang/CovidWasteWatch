...
trends in COVID-19 viral signal levels and variant frequencies over time, along 
with options to visualize supplementary data such as reported cases and 
mortality from public sources. 
`CovidWasteWatch` was developed using `R version 4.3.1`, `Platform: 
`x86_64-w64-mingw32/x64on`, and `Running under: Windows 11 x64`.
...
`CovidWasteWatch` provides __ functions:
...
This package was developed by Vivian Wang, who formed the concept 
and wrote the code.
